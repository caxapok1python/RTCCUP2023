...
const int lowServoRange[3] = {0, 80, 40};
const int midServoRange[3] = {0, 90, 45};
const int highServoRange[3] = {5, 70, 35};
const int catchBanka = 60;

const int defaultPos[2] = {0, 80}; // 1
const int zeroPos[2] = {0, 0};
const int workPos[2] = {80, 0}; // 2
const int upPos[2] = {0,30}; // 3
